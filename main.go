...
//go:generate go-bindata -prefix res/ -pkg assets -o assets/assets.go res/DiscordCanary.lnk res/pinned_update.json
...
import (
	...
	"github.com/portapps/discord-canary-portable/assets"
...
func main() {
	...
	app.Process = filepath.Join(electronAppPath, "DiscordCanary.exe")
	app.Args = []string{
  ...
  "USE_PINNED_UPDATE_MANIFEST": true
	...
	err = shortcut.Create(shortcut.Shortcut{
		...
		Description:      shortcut.Property{Value: "Discord Canary Portable by Portapps"},
